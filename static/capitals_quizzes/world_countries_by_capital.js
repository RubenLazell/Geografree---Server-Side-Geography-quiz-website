document.addEventListener('DOMContentLoaded', () => {
    const quizName = 'world_countries_by_capital';
    ...
    function askNextQuestion() {
        ...
        if (currentQuestionIndex < countries.length) {
            stateQuestion.textContent = (countries[currentQuestionIndex].capital).split(' ')
    ...
    function endQuiz() {
        console.log("endQuiz function triggered"); // Log when endQuiz is triggered
