document.addEventListener('DOMContentLoaded', () => {
    const quizName = 'north_american_country_name_challenge';
    ...
    function fetchCountries() {
        fetch('https://restcountries.com/v3.1/all')
            ...
            .then(data => {
                countries = data
                .filter(country => (country.region === 'Americas' && (country.subregion === 'North America' || country.subregion === 'Central America' || country.subregion === 'Caribbean')))
    ...
    function endQuizSuccess() {
        clearInterval(timer);
        showMessage(`Congratulations! You've named all the countries in North America! You have earned ${calculateXP(score, totalCountries)} xp.`);
