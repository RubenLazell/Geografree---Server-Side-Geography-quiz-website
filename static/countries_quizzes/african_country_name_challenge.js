document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizName = 'african_country_name_challenge';
    ...
    function fetchCountries() {
        fetch('https://restcountries.com/v3.1/all')
            ...
            .then(data => {
                countries = data
                .filter(country => country.region === 'Africa' && country.independent === true) // filter for Africa
    ...
    function endQuizSuccess() {
        ...
        showMessage(`Congratulations! You've named all the countries in Africa! You have earned ${calculateXP(score, totalCountries)} xp.`);
